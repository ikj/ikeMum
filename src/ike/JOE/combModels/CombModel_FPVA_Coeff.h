...
public:
  ...
  virtual void initialHookScalarRansCombModel()
  {
    ...
    {
      scalarTranspEqVector[ZMean_Index].dpress_dphi = new double[ncv_gg];
      scalarTranspEqVector[ZVar_Index ].dpress_dphi = new double[ncv_gg];
      scalarTranspEqVector[CMean_Index].dpress_dphi = new double[ncv_gg];
      dCmeanSource_dZM = new double[ncv_gg];
      dCmeanSource_dZV = new double[ncv_gg];
      dCmeanSource_dCM = new double[ncv_gg];
    }
  ...
  virtual void pressureDerivativeHookScalarRansComb() 
  {
    ...
    updateCvDataG1G2(scalarTranspEqVector[ZMean_Index].dpress_dphi, REPLACE_DATA);
    updateCvDataG1G2(scalarTranspEqVector[ZVar_Index].dpress_dphi, REPLACE_DATA);
    updateCvDataG1G2(scalarTranspEqVector[CMean_Index].dpress_dphi, REPLACE_DATA);
    updateCvDataG1G2(dCmeanSource_dZM, REPLACE_DATA);
    updateCvDataG1G2(dCmeanSource_dZV, REPLACE_DATA);
    updateCvDataG1G2(dCmeanSource_dCM, REPLACE_DATA);
  } 
   ...
   */
  void ComputeProperties_T(double &h, double &RoM, double &gam, double T, double zm, double zv, double cm)
  {
    double dummy;
  ...
  void ComputeProperties_vis(double &mu, double &lamOcp, double T, double zm, double zv, double cm)
  {
    double dummy,h,RoM,gam;
   ...
   *  \param[in]  chi Scalar dissipation rate.
   */
  void ComputeProperties_H(double &T, double &RoM, double &gam, double h, double zm, double zv, double cm)
  {
    double dummy;
  ...
  void ComputeScalarDissipation(double *chi)
  {
    ...
    updateCvDataG1G2(chi, REPLACE_DATA);
  }
